...
values
  ...
  ('20000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', 'Estúdio Maré'),
  ('20000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', 'Casa Norte'),
...
values
  ...
  ('30000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000003', 'Portal de parceiros', 'Integrações de onboarding para uma nova área de parceiros.', 'ACTIVE', now() - interval '1 day'),
  ('30000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000004', 'Marca em movimento', 'Sistema de campanha para o novo posicionamento.', 'ACTIVE', now() - interval '3 days'),
...
values
  ...
  ('40000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000004', 'Integração de CRM', 'Conexão do formulário de parceiros com o CRM de demonstração.', 'IN_PROGRESS', now() + interval '8 days', false),
  ('40000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000005', 'Kit de lançamento', 'Materiais internos aguardando decisão de revisão.', 'IN_REVIEW', now() + interval '9 days', false),
  ('40000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000005', 'Guia de tom de voz', 'Entrega saudável que aparece fora da fila de exceções.', 'IN_PROGRESS', now() + interval '14 days', false),
...
values
  ...
  ('50000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000102', 'Validar analytics', 'Bloqueio futuro independente.', 'TODO', 'HIGH', now() + interval '8 days', true, 'Aguardando acesso fictício à ferramenta de métricas.'),
  ('50000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000101', 'Conferir checklist interno', 'Conferência final antes de liberar os materiais.', 'DONE', 'LOW', now() - interval '1 day', false, null),
  ('50000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000101', 'Registrar decisões de tom', 'Registro saudável das decisões criativas.', 'DONE', 'LOW', now() + interval '7 days', false, null),
...
values
  ('70000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000101', null, 'PENDING', null, now() - interval '3 days', null),
...
values
  ('80000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000101', 'approval.requested', 'deliverable', '40000000-0000-0000-0000-000000000006', '{"source":"seed"}', now() - interval '3 days'),
